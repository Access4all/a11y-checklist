...
Nur wenn man im Fokus-Modus ([🏷️ Fokus-Modus](/en/tags/werkzeuge/screenreader/desktop-screenreader/fokus-modus)) auf ein Element springt, sagt der Screenreader die verknüpfte Beschreibung an. Im Browse-Modus ([🏷️ Browse-Modus](/en/tags/werkzeuge/screenreader/desktop-screenreader/browse-modus)) nicht.
