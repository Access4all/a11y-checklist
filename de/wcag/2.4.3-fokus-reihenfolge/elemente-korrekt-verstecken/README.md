...
1. Seite öffnen
1. [🏷️ NerdeFocus Extension](/de/tags/werkzeuge/extensions/nerdefocus-extension) aktivieren
1. Mit `Tab`-Taste durch die Seite navigieren
    - Sicher stellen, dass der Fokus sich nie links oder rechts aus dem Viewport hinaus bewegt (siehe [🏷️ Inhalte rein visuell verstecken](/de/tags/techniken/inhalte-verstecken/inhalte-rein-visuell-verstecken)).
