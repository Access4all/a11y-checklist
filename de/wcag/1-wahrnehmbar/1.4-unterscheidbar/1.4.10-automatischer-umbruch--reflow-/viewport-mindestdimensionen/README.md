...
# Prüfpunkt: Viewport-Mindestdimensionen
...
1. Seite öffnen
1. In der 🏷️-51 auf `Resize` → `Resize Window...` klicken und `256`x`320` einstellen (alternativ im 🏷️-47 über die `Geräte Toolbar` möglich)
